...
from load_dataset import load_cifar5_un_fix
...
def unlearning_model(un_c, un_num):
    ...
    torch.manual_seed(1)
    path = "./data_half"
    train, test = load_cifar5_un_fix(path, un_c, un_num)
    train_batch_size = 64
    test_batch_size = 64
    ...
    for epoch in range(1, epochs + 1):
        ...
        scheduler.step()
    torch.save(model.state_dict(), f"./models_ex3/cifar5_cnn_{un_c}_{un_num}.pth")
